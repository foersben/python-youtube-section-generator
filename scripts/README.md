...
- `docs/CPU_RAG_FIXED.md` - CPU-only setup guide
- `docs/CPU_ONLY_SETUP_SUMMARY.md` - Setup summary
- `docs/RAG_COMPLETE.md` - RAG system documentation
- `docs/RAG_REFINEMENT_SUMMARY.md` - RAG enhancements
