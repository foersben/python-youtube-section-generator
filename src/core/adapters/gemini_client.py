...
def _get_gemini_provider(api_key_env: str | None = None, model: str | None = None, temperature: float = 0.0):
...
class GeminiService:
    ...
    def generate(self, prompt: str, cache_contents: List[str], system_instruction: str = "", thinking_budget: int = 0, temperature: float = 0.0, retry_delay: float = 5.0, max_delay: float = 60.0) -> str:
